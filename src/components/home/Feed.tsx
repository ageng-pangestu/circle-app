        ...
        <Box>
          <Box sx={{ display: "flex", alignItems: "center", marginBottom: 1 }}>
            <Typography variant="body1" sx={{ marginRight: 1 }}>
              <Link to={"UserDetail/" + "1"} style={{ color: "white", textDecoration: "none" }}>
                {item.fullName}
              </Link>
            </Typography>
          ...
          <Box sx={{ display: "flex", gap: 2 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", marginBottom: 1, gap: 1 }}>
              <Icon icon={"majesticons:comment-2-text-line"} fontSize={"25px"} />
              <Typography>{item.totalReplies}</Typography>
            </Box>
          </Box>
        </Box>
      </Box>
